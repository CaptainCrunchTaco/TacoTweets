...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "74L8NyB4XZvSZ7Bn1LSWZ5VBD";       // Change this
	public static final String REST_CONSUMER_SECRET = "yQKxVgCJFLdSdtQ1MpTsm4AxtsRc8s0kWEjtuBFpghYmehnoQw"; // Change this
	public static final String REST_CALLBACK_URL = "oauth://tacotweets"; // Change this (here and in manifest)
